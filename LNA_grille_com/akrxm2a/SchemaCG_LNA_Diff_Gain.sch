...
<Properties>
  <View=-268,-200,1290,636,1.00957,0,0>
  <Grid=5,5,1>
...
<Components>
  ...
  <C C1 1 440 -10 17 -26 0 1 "1.41p F" 1 "" 0 "neutral" 0>
  <C C2 1 775 20 17 -26 0 1 "1.41p F" 1 "" 0 "neutral" 0>
  <INCLSCR INCLSCR1 1 -120 -65 -60 16 0 0 ".LIB cornerMOSlv.lib mos_tt\n\n.LIB cornerRES.lib res_typ\n.LIB cornerCAP.lib cap_typ\n\n.LIB cornerRES.lib res_wcs\n" 1 "" 0 "" 0>
  <NutmegEq NutmegEq1 1 -115 130 -30 18 0 0 "ALL" 1 "g1=dB(s_2_1)+10*log10(5000/50)" 1 "g2=dB(s_4_3)+10*log10(5000/50)" 1>
  <.SP SP1 1 -150 265 0 70 0 0 "lin" 1 "1 MHz" 1 "5 GHz" 1 "1001" 1 "no" 1 "1" 1 "2" 1 "no" 0 "no" 0>
  <Pac P2 1 560 520 18 -26 0 1 "3" 1 "50 Ohm" 1 "0 dBm" 0 "2.45 GHz" 0 "26.85" 0 "true" 0>
  <Pac P1 1 250 525 18 -26 0 1 "1" 1 "50 Ohm" 1 "0 dBm" 0 "2.45 GHz" 0 "26.85" 0 "true" 0>
  <GND * 1 520 110 0 0 0 0>
  <GND * 1 850 110 0 0 0 0>
  <Pac P4 1 850 80 18 -26 0 1 "4" 1 "50 Ohm" 1 "0 dBm" 0 "2.45 GHz" 0 "26.85" 0 "true" 0>
  <Pac P3 1 520 80 18 -26 0 1 "2" 1 "50 Ohm" 1 "0 dBm" 0 "2.45 GHz" 0 "26.85" 0 "true" 0>
</Components>
<Wires>
  <340 -60 340 -30 "" 0 0 0 "">
...
<Diagrams>
  <Rect 895 550 240 160 3 #c0c0c0 1 00 1 0 1e+09 5e+09 1 -127.309 100 29.4985 1 -1 1 1 315 0 225 1 0 0 "" "" "">
	<"ngspice/ac.g2" #ff0000 0 3 0 0 0>
	  <Mkr 2.40552e+09 91 -67 3 0 0>
  </Rect>
  <Smith 920 300 200 200 3 #c0c0c0 1 00 1 0 1 1 1 0 4 1 1 0 1 1 315 0 225 1 0 0 "" "" "">
	<"ngspice/ac.v(s_2_2)" #0000ff 0 3 0 0 0>
	  <Mkr 2.45051e+09 71 -202 3 0 0>
	<"ngspice/ac.v(s_4_4)" #ff0000 0 3 0 0 0>
  </Smith>
  <Smith 915 40 200 200 3 #c0c0c0 1 00 1 0 1 1 1 0 4 1 1 0 1 1 315 0 225 1 0 0 "" "" "">
	<"ngspice/ac.v(s_1_1)" #ff00ff 0 3 0 0 0>
	  <Mkr 2.54049e+09 41 -181 3 0 0>
  </Smith>
</Diagrams>
<Paintings>
</Paintings>
