...
<Properties>
  <View=-1253,-452,2181,1521,0.748494,662,368>
  <Grid=10,10,1>
...
<Symbol>
  ...
  <Text 280 110 9 #000000 0 "VOUT2\n">
  <Text 270 210 9 #000000 0 "VOUT1\n">
  <Text 30 120 9 #000000 0 "VIN">
  <Text 20 210 9 #000000 0 "VOFFSET">
  <.PortSym 270 140 2 180 VOUT2>
  <.PortSym 270 190 1 180 VOUT1>
</Symbol>
<Components>
  <GND * 1 450 -250 0 0 0 2>
  ...
  <Vdc V1 1 450 -190 -51 -26 0 3 "1.2" 1>
  ...
  <SpicePar SpicePar1 1 170 200 -28 18 0 0 "w=18.3u" 1 "l=18.3u" 1 "Io=1.5mA" 1>
  ...
  <Port VOUT1 1 680 290 4 -46 0 2 "1" 1 "analog" 0>
  <Port VOUT2 1 260 280 -23 12 0 0 "2" 1 "analog" 0>
  <Port VOFFSET 1 230 550 4 -46 0 2 "5" 1 "analog" 0>
  <Port VCTRL 1 450 -60 -23 12 0 0 "6" 1 "analog" 0>
</Components>
<Wires>
  ...
  <-150 380 -30 380 "Vou_m" -80 350 46 "">
  <930 450 970 450 "" 0 0 0 "">
  <450 100 470 100 "" 0 0 0 "">
  <450 60 450 100 "" 0 0 0 "">
  <680 290 680 330 "mos2" 610 300 10 "">
  <260 280 260 330 "mos1" 340 300 16 "">
