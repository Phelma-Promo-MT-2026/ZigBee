...
<Properties>
  <View=-124,-193,1684,836,0.842566,0,0>
  <Grid=10,10,1>
  <DataSet=Step_7_bonding_adapt_sortie_test.dat>
  <DataDisplay=Step_7_bonding_adapt_sortie_test.dpl>
  <OpenDisplay=0>
...
<Components>
  ...
  <Vdc Vdd 1 420 -20 18 -26 0 1 "1.2 V" 1>
  <GND * 1 420 10 0 0 0 0>
  <GND * 1 540 0 0 0 0 0>
  <C C12 1 540 -30 17 -26 0 1 "100fF" 1 "" 0 "neutral" 0>
  <Pac P2 1 1190 150 18 -26 0 1 "2" 1 "50 Ohm" 1 "0 dBm" 0 "1 MHz" 0 "26.85" 0 "true" 0>
  <GND * 1 1190 180 0 0 0 0>
  <GND * 1 1040 150 0 0 0 0>
  <C C13 1 1040 120 17 -26 0 1 "100fF" 1 "" 0 "neutral" 0>
  <L L3 1 1140 90 -26 10 0 0 "2 nH" 1 "" 0>
  <Pac P1 1 250 580 18 -26 0 1 "1" 1 "50 Ohm" 1 "0 dBm" 0 "1 MHz" 0 "26.85" 0 "true" 0>
  <GND * 1 250 610 0 0 0 0>
  <L L5 1 320 540 -26 10 0 0 "2 nH" 1 "" 0>
  <GND * 1 380 600 0 0 0 0>
  <C C14 1 380 570 17 -26 0 1 "100fF" 1 "" 0 "neutral" 0>
  <C C11 1 910 90 -26 -51 0 2 "1.14pF" 1 "" 0 "neutral" 0>
  <C C10 1 970 210 17 -26 0 1 "1.74pF" 1 "" 0 "neutral" 0>
  <L L2 1 500 -60 -26 10 0 0 "2 nH" 1 "" 0>
  <C C7 1 640 450 -26 17 0 0 "1.01p" 1 "" 0 "neutral" 0>
</Components>
<Wires>
  ...
  <540 -60 620 -60 "Vdd" 630 -90 80 "">
  <970 90 1040 90 "" 0 0 0 "">
  <1190 90 1190 120 "" 0 0 0 "">
  <1170 90 1190 90 "" 0 0 0 "">
  <1040 90 1110 90 "" 0 0 0 "">
  <250 540 250 550 "" 0 0 0 "">
  <250 540 290 540 "" 0 0 0 "">
  <350 540 380 540 "" 0 0 0 "">
  <380 460 380 540 "" 0 0 0 "">
  <530 -60 540 -60 "" 0 0 0 "">
  <420 -60 420 -50 "" 0 0 0 "">
  <420 -60 470 -60 "" 0 0 0 "">
...
<Diagrams>
  ...
  <Rect 1100 740 240 160 3 #c0c0c0 1 00 1 0 0.2 1 1 -0.1 0.5 1.1 1 -0.1 0.5 1.1 315 0 225 1 0 0 "" "" "">
