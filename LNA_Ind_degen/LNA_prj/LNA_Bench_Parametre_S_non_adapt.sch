...
<Properties>
  <View=-382,-67,1769,1121,0.729798,0,0>
  <Grid=10,10,1>
  <DataSet=LNA_Bench_Parametre_S_non_adapt.dat>
  <DataDisplay=LNA_Bench_Parametre_S_non_adapt.dpl>
  <OpenDisplay=0>
...
<Components>
  <Pac P2 1 840 170 18 -26 0 1 "2" 1 "5000 Ohm" 1 "0 dBm" 0 "1 MHz" 0 "26.85" 0 "true" 0>
  ...
  <NutmegEq NutmegEq1 1 140 400 -30 18 0 0 "ALL" 1 "G=db(s_2_1) + 10*log10(5000/50)" 1 "S_1_1_dB=dB(s_1_1)" 1 "S_1_2_dB=dB(s_1_2)" 1 "S_2_1_dB=dB(s_2_1)" 1 "S_2_2_dB=dB(s_2_2)" 1 "delta=abs((s_1_1*s_2_2) - (s_1_2*s_2_1))" 1 "K=(1-abs(s_1_1)^2-abs(s_2_2)^2+delta^2)/(2*abs(s_1_2*s_2_1))" 1>
  <.SP SP1 1 110 210 0 70 0 0 "lin" 1 "1 MHz" 1 "20 GHz" 1 "2001" 1 "no" 0 "1" 0 "2" 0 "no" 0 "no" 0>
  <Sub LNA 1 620 140 -26 162 0 0 "../../../../../QucsWorkspace/Zigbee/LNA_Ind_degen/LNA_prj/LNA_non_adapt_sym.sch" 0>
</Components>
<Wires>
...
<Diagrams>
  ...
  <Smith 493 545 255 255 3 #c0c0c0 1 00 1 0 1 1 1 0 4 1 1 0 1 1 315 0 225 1 0 0 "" "" "">
	<"ngspice/ac.v(s_1_1)" #0000ff 1 3 0 0 0>
	  <Mkr 2.45088e+09 226 -270 3 0 0>
	<"ngspice/ac.v(s_2_2)" #ff0000 1 3 0 0 0>
	  <Mkr 2.45088e+09 -186 -275 3 0 0>
  </Smith>
