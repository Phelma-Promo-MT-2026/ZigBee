...
<Properties>
  <View=-229,-346,2689,1205,0.796456,100,134>
  <Grid=10,10,1>
...
<Components>
  ...
  <Vdc Vgs 1 150 680 18 -26 0 1 "0.38 V" 1>
  <GND * 1 150 710 0 0 0 0>
  <L L3 1 150 590 10 -26 0 1 "1 H" 1 "" 0>
  <C C1 1 620 170 17 -26 0 1 "1.41 pF" 1 "" 0 "neutral" 0>
  <GND * 0 670 380 0 0 0 0>
  <Pac P2 0 670 340 18 -26 0 1 "2" 1 "50 Ohm" 1 "0 dBm" 0 "1 MHz" 0 "26.85" 0 "true" 0>
  <C C3 0 670 250 17 -26 0 1 "1 F" 1 "" 0 "neutral" 0>
  <IProbe Pr1 1 430 440 -33 -26 0 3>
  <.DC DC1 1 740 170 0 99 0 0 "26.85" 0 "0.001" 0 "1 pA" 0 "1 uV" 0 "no" 0 "150" 0 "no" 0 "none" 0 "CroutLU" 0>
  <.SW SW1 1 770 300 0 70 0 0 "DC1" 1 "lin" 1 "Vgs" 1 "0.2" 1 "0.4" 1 "201" 1>
  ...
  <INCLSCR INCLSCR2 1 20 160 -60 16 0 0 ".LIB cornerMOSlv.lib mos_tt\n.save i(vids)\n.save all @n.mn0.x1.nsg13_lv_nmos[gm]" 1 "" 0 "" 0>
</Components>
<Wires>
...
<Diagrams>
  <Rect 1017 712 833 508 3 #c0c0c0 1 00 1 0.2 0.05 1 1 -0.01 0.01 0.0927763 1 -1 0.2 1 315 0 225 1 0 0 "Vgs" "gm" "">
