...
pts_x = np.array([])
pts_y = np.array([])
pts_x = r_[pts_x, 3.950]
pts_y = r_[pts_y, 227.000]
pts_x = r_[pts_x, -8.070]
pts_y = r_[pts_y, 239.020]
pts_x = r_[pts_x, -18.915]
pts_y = r_[pts_y, 239.020]
pts_x = r_[pts_x, -18.915]
pts_y = r_[pts_y, 249.020]
pts_x = r_[pts_x, -3.950]
pts_y = r_[pts_y, 249.020]
pts_x = r_[pts_x, 8.070]
pts_y = r_[pts_y, 237.000]
pts_x = r_[pts_x, 18.915]
pts_y = r_[pts_y, 237.000]
pts_x = r_[pts_x, 18.915]
pts_y = r_[pts_y, 227.000]
...
pts_x = r_[pts_x, -8.080]
pts_y = r_[pts_y, 40.000]
pts_x = r_[pts_x, 3.920]
pts_y = r_[pts_y, 52.000]
pts_x = r_[pts_x, 18.925]
pts_y = r_[pts_y, 52.000]
pts_x = r_[pts_x, 18.925]
pts_y = r_[pts_y, 42.000]
pts_x = r_[pts_x, 8.070]
pts_y = r_[pts_y, 42.000]
pts_x = r_[pts_x, -3.930]
pts_y = r_[pts_y, 30.000]
pts = np.array([pts_x, pts_y])
TopMetal1.AddLinPoly(priority=200, points=pts, norm_dir ='z', elevation=TopMetal1_zmin, length=TopMetal1_thick)
...
pts_x = np.array([])
pts_y = np.array([])
pts_x = r_[pts_x, 30.915]
pts_y = r_[pts_y, -1.000]
pts_x = r_[pts_x, 20.915]
pts_y = r_[pts_y, -1.000]
pts_x = r_[pts_x, 20.915]
pts_y = r_[pts_y, 64.000]
pts_x = r_[pts_x, 30.915]
pts_y = r_[pts_y, 64.000]
pts = np.array([pts_x, pts_y])
TopMetal1.AddLinPoly(priority=200, points=pts, norm_dir ='z', elevation=TopMetal1_zmin, length=TopMetal1_thick)
...
pts_y = np.array([])
pts_x = r_[pts_x, 20.915]
pts_y = r_[pts_y, 54.000]
pts_x = r_[pts_x, 20.915]
pts_y = r_[pts_y, 64.000]
pts_x = r_[pts_x, 33.755]
pts_y = r_[pts_y, 64.000]
pts_x = r_[pts_x, 81.500]
pts_y = r_[pts_y, 111.745]
pts_x = r_[pts_x, 81.500]
pts_y = r_[pts_y, 179.255]
pts_x = r_[pts_x, 33.755]
pts_y = r_[pts_y, 227.000]
pts_x = r_[pts_x, 8.915]
pts_y = r_[pts_y, 227.000]
pts_x = r_[pts_x, 8.915]
pts_y = r_[pts_y, 237.000]
pts_x = r_[pts_x, 37.905]
pts_y = r_[pts_y, 237.000]
pts_x = r_[pts_x, 91.500]
pts_y = r_[pts_y, 183.405]
pts_x = r_[pts_x, 91.500]
pts_y = r_[pts_y, 107.595]
pts_x = r_[pts_x, 37.905]
pts_y = r_[pts_y, 54.000]
pts = np.array([pts_x, pts_y])
...
pts_x = r_[pts_x, 8.915]
pts_y = r_[pts_y, 52.000]
pts_x = r_[pts_x, 38.730]
pts_y = r_[pts_y, 52.000]
pts_x = r_[pts_x, 93.510]
pts_y = r_[pts_y, 106.780]
pts_x = r_[pts_x, 93.510]
pts_y = r_[pts_y, 184.240]
pts_x = r_[pts_x, 38.730]
pts_y = r_[pts_y, 239.020]
pts_x = r_[pts_x, 8.915]
pts_y = r_[pts_y, 239.020]
pts_x = r_[pts_x, 8.915]
pts_y = r_[pts_y, 249.020]
pts_x = r_[pts_x, 42.880]
pts_y = r_[pts_y, 249.020]
pts_x = r_[pts_x, 103.510]
pts_y = r_[pts_y, 188.390]
pts_x = r_[pts_x, 103.510]
pts_y = r_[pts_y, 102.630]
pts_x = r_[pts_x, 42.880]
pts_y = r_[pts_y, 42.000]
pts = np.array([pts_x, pts_y])
TopMetal2.AddLinPoly(priority=200, points=pts, norm_dir ='z', elevation=TopMetal2_zmin, length=TopMetal2_thick)
...
pts_x = r_[pts_x, 8.915]
pts_y = r_[pts_y, 40.000]
pts_x = r_[pts_x, 43.705]
pts_y = r_[pts_y, 40.000]
pts_x = r_[pts_x, 105.520]
pts_y = r_[pts_y, 101.815]
pts_x = r_[pts_x, 105.520]
pts_y = r_[pts_y, 189.225]
pts_x = r_[pts_x, 43.705]
pts_y = r_[pts_y, 251.040]
pts_x = r_[pts_x, 8.915]
pts_y = r_[pts_y, 251.040]
pts_x = r_[pts_x, 8.915]
pts_y = r_[pts_y, 261.040]
pts_x = r_[pts_x, 47.855]
pts_y = r_[pts_y, 261.040]
pts_x = r_[pts_x, 115.520]
pts_y = r_[pts_y, 193.375]
pts_x = r_[pts_x, 115.520]
pts_y = r_[pts_y, 97.665]
pts_x = r_[pts_x, 47.855]
pts_y = r_[pts_y, 30.000]
pts = np.array([pts_x, pts_y])
TopMetal2.AddLinPoly(priority=200, points=pts, norm_dir ='z', elevation=TopMetal2_zmin, length=TopMetal2_thick)
...
pts_x = np.array([])
pts_y = np.array([])
pts_x = r_[pts_x, 9.545]
pts_y = r_[pts_y, 227.630]
pts_x = r_[pts_x, 9.545]
pts_y = r_[pts_y, 228.530]
pts_x = r_[pts_x, 10.445]
pts_y = r_[pts_y, 228.530]
pts_x = r_[pts_x, 10.445]
pts_y = r_[pts_y, 227.630]
pts = np.array([pts_x, pts_y])
...
pts_x = np.array([])
pts_y = np.array([])
pts_x = r_[pts_x, 11.505]
pts_y = r_[pts_y, 227.630]
pts_x = r_[pts_x, 11.505]
pts_y = r_[pts_y, 228.530]
pts_x = r_[pts_x, 12.405]
pts_y = r_[pts_y, 228.530]
pts_x = r_[pts_x, 12.405]
pts_y = r_[pts_y, 227.630]
pts = np.array([pts_x, pts_y])
...
pts_x = np.array([])
pts_y = np.array([])
pts_x = r_[pts_x, 13.465]
pts_y = r_[pts_y, 227.630]
pts_x = r_[pts_x, 13.465]
pts_y = r_[pts_y, 228.530]
pts_x = r_[pts_x, 14.365]
pts_y = r_[pts_y, 228.530]
pts_x = r_[pts_x, 14.365]
pts_y = r_[pts_y, 227.630]
pts = np.array([pts_x, pts_y])
...
pts_x = np.array([])
pts_y = np.array([])
pts_x = r_[pts_x, 15.425]
pts_y = r_[pts_y, 227.630]
pts_x = r_[pts_x, 15.425]
pts_y = r_[pts_y, 228.530]
pts_x = r_[pts_x, 16.325]
pts_y = r_[pts_y, 228.530]
pts_x = r_[pts_x, 16.325]
pts_y = r_[pts_y, 227.630]
pts = np.array([pts_x, pts_y])
...
pts_x = np.array([])
pts_y = np.array([])
pts_x = r_[pts_x, 17.385]
pts_y = r_[pts_y, 227.630]
pts_x = r_[pts_x, 17.385]
pts_y = r_[pts_y, 228.530]
pts_x = r_[pts_x, 18.285]
pts_y = r_[pts_y, 228.530]
pts_x = r_[pts_x, 18.285]
pts_y = r_[pts_y, 227.630]
pts = np.array([pts_x, pts_y])
...
pts_y = np.array([])
pts_x = r_[pts_x, 9.545]
pts_y = r_[pts_y, 229.590]
pts_x = r_[pts_x, 9.545]
pts_y = r_[pts_y, 230.490]
pts_x = r_[pts_x, 10.445]
pts_y = r_[pts_y, 230.490]
pts_x = r_[pts_x, 10.445]
pts_y = r_[pts_y, 229.590]
...
pts_y = np.array([])
pts_x = r_[pts_x, 9.545]
pts_y = r_[pts_y, 231.550]
pts_x = r_[pts_x, 9.545]
pts_y = r_[pts_y, 232.450]
pts_x = r_[pts_x, 10.445]
pts_y = r_[pts_y, 232.450]
pts_x = r_[pts_x, 10.445]
pts_y = r_[pts_y, 231.550]
...
pts_y = np.array([])
pts_x = r_[pts_x, 9.545]
pts_y = r_[pts_y, 233.510]
pts_x = r_[pts_x, 9.545]
pts_y = r_[pts_y, 234.410]
pts_x = r_[pts_x, 10.445]
pts_y = r_[pts_y, 234.410]
pts_x = r_[pts_x, 10.445]
pts_y = r_[pts_y, 233.510]
...
pts_y = np.array([])
pts_x = r_[pts_x, 9.545]
pts_y = r_[pts_y, 235.470]
pts_x = r_[pts_x, 9.545]
pts_y = r_[pts_y, 236.370]
pts_x = r_[pts_x, 10.445]
pts_y = r_[pts_y, 236.370]
pts_x = r_[pts_x, 10.445]
pts_y = r_[pts_y, 235.470]
...
pts_y = np.array([])
pts_x = r_[pts_x, -14.365]
pts_y = r_[pts_y, 243.550]
pts_x = r_[pts_x, -14.365]
pts_y = r_[pts_y, 244.450]
pts_x = r_[pts_x, -13.465]
pts_y = r_[pts_y, 244.450]
pts_x = r_[pts_x, -13.465]
pts_y = r_[pts_y, 243.550]
...
pts_y = np.array([])
pts_x = r_[pts_x, -12.405]
pts_y = r_[pts_y, 241.590]
pts_x = r_[pts_x, -12.405]
pts_y = r_[pts_y, 242.490]
pts_x = r_[pts_x, -11.505]
pts_y = r_[pts_y, 242.490]
pts_x = r_[pts_x, -11.505]
pts_y = r_[pts_y, 241.590]
...
pts_y = np.array([])
pts_x = r_[pts_x, -16.325]
pts_y = r_[pts_y, 239.630]
pts_x = r_[pts_x, -16.325]
pts_y = r_[pts_y, 240.530]
pts_x = r_[pts_x, -15.425]
pts_y = r_[pts_y, 240.530]
pts_x = r_[pts_x, -15.425]
pts_y = r_[pts_y, 239.630]
...
pts_y = np.array([])
pts_x = r_[pts_x, -10.445]
pts_y = r_[pts_y, 245.510]
pts_x = r_[pts_x, -10.445]
pts_y = r_[pts_y, 246.410]
pts_x = r_[pts_x, -9.545]
pts_y = r_[pts_y, 246.410]
pts_x = r_[pts_x, -9.545]
pts_y = r_[pts_y, 245.510]
...
pts_y = np.array([])
pts_x = r_[pts_x, -10.445]
pts_y = r_[pts_y, 247.470]
pts_x = r_[pts_x, -10.445]
pts_y = r_[pts_y, 248.370]
pts_x = r_[pts_x, -9.545]
pts_y = r_[pts_y, 248.370]
pts_x = r_[pts_x, -9.545]
pts_y = r_[pts_y, 247.470]
...
pts_x = np.array([])
pts_y = np.array([])
pts_x = r_[pts_x, -22.445]
pts_y = r_[pts_y, 54.630]
pts_x = r_[pts_x, -22.445]
pts_y = r_[pts_y, 55.530]
pts_x = r_[pts_x, -21.545]
pts_y = r_[pts_y, 55.530]
pts_x = r_[pts_x, -21.545]
pts_y = r_[pts_y, 54.630]
pts = np.array([pts_x, pts_y])
...
pts_x = np.array([])
pts_y = np.array([])
pts_x = r_[pts_x, -24.405]
pts_y = r_[pts_y, 54.630]
pts_x = r_[pts_x, -24.405]
pts_y = r_[pts_y, 55.530]
pts_x = r_[pts_x, -23.505]
pts_y = r_[pts_y, 55.530]
pts_x = r_[pts_x, -23.505]
pts_y = r_[pts_y, 54.630]
pts = np.array([pts_x, pts_y])
...
pts_x = np.array([])
pts_y = np.array([])
pts_x = r_[pts_x, -26.365]
pts_y = r_[pts_y, 54.630]
pts_x = r_[pts_x, -26.365]
pts_y = r_[pts_y, 55.530]
pts_x = r_[pts_x, -25.465]
pts_y = r_[pts_y, 55.530]
pts_x = r_[pts_x, -25.465]
pts_y = r_[pts_y, 54.630]
pts = np.array([pts_x, pts_y])
...
pts_x = np.array([])
pts_y = np.array([])
pts_x = r_[pts_x, -28.325]
pts_y = r_[pts_y, 54.630]
pts_x = r_[pts_x, -28.325]
pts_y = r_[pts_y, 55.530]
pts_x = r_[pts_x, -27.425]
pts_y = r_[pts_y, 55.530]
pts_x = r_[pts_x, -27.425]
pts_y = r_[pts_y, 54.630]
pts = np.array([pts_x, pts_y])
...
pts_x = np.array([])
pts_y = np.array([])
pts_x = r_[pts_x, -30.285]
pts_y = r_[pts_y, 54.630]
pts_x = r_[pts_x, -30.285]
pts_y = r_[pts_y, 55.530]
pts_x = r_[pts_x, -29.385]
pts_y = r_[pts_y, 55.530]
pts_x = r_[pts_x, -29.385]
pts_y = r_[pts_y, 54.630]
pts = np.array([pts_x, pts_y])
...
pts_y = np.array([])
pts_x = r_[pts_x, -22.445]
pts_y = r_[pts_y, 56.590]
pts_x = r_[pts_x, -22.445]
pts_y = r_[pts_y, 57.490]
pts_x = r_[pts_x, -21.545]
pts_y = r_[pts_y, 57.490]
pts_x = r_[pts_x, -21.545]
pts_y = r_[pts_y, 56.590]
...
pts_y = np.array([])
pts_x = r_[pts_x, -22.445]
pts_y = r_[pts_y, 58.550]
pts_x = r_[pts_x, -22.445]
pts_y = r_[pts_y, 59.450]
pts_x = r_[pts_x, -21.545]
pts_y = r_[pts_y, 59.450]
pts_x = r_[pts_x, -21.545]
pts_y = r_[pts_y, 58.550]
...
pts_y = np.array([])
pts_x = r_[pts_x, -22.445]
pts_y = r_[pts_y, 60.510]
pts_x = r_[pts_x, -22.445]
pts_y = r_[pts_y, 61.410]
pts_x = r_[pts_x, -21.545]
pts_y = r_[pts_y, 61.410]
pts_x = r_[pts_x, -21.545]
pts_y = r_[pts_y, 60.510]
...
pts_y = np.array([])
pts_x = r_[pts_x, -22.445]
pts_y = r_[pts_y, 62.470]
pts_x = r_[pts_x, -22.445]
pts_y = r_[pts_y, 63.370]
pts_x = r_[pts_x, -21.545]
pts_y = r_[pts_y, 63.370]
pts_x = r_[pts_x, -21.545]
pts_y = r_[pts_y, 62.470]
...
pts_y = np.array([])
pts_x = r_[pts_x, -10.445]
pts_y = r_[pts_y, 30.630]
pts_x = r_[pts_x, -10.445]
pts_y = r_[pts_y, 31.530]
pts_x = r_[pts_x, -9.545]
pts_y = r_[pts_y, 31.530]
pts_x = r_[pts_x, -9.545]
pts_y = r_[pts_y, 30.630]
...
pts_y = np.array([])
pts_x = r_[pts_x, -10.445]
pts_y = r_[pts_y, 32.590]
pts_x = r_[pts_x, -10.445]
pts_y = r_[pts_y, 33.490]
pts_x = r_[pts_x, -9.545]
pts_y = r_[pts_y, 33.490]
pts_x = r_[pts_x, -9.545]
pts_y = r_[pts_y, 32.590]
...
pts_y = np.array([])
pts_x = r_[pts_x, -10.445]
pts_y = r_[pts_y, 34.550]
pts_x = r_[pts_x, -10.445]
pts_y = r_[pts_y, 35.450]
pts_x = r_[pts_x, -9.545]
pts_y = r_[pts_y, 35.450]
pts_x = r_[pts_x, -9.545]
pts_y = r_[pts_y, 34.550]
...
pts_y = np.array([])
pts_x = r_[pts_x, -10.445]
pts_y = r_[pts_y, 36.510]
pts_x = r_[pts_x, -10.445]
pts_y = r_[pts_y, 37.410]
pts_x = r_[pts_x, -9.545]
pts_y = r_[pts_y, 37.410]
pts_x = r_[pts_x, -9.545]
pts_y = r_[pts_y, 36.510]
...
pts_y = np.array([])
pts_x = r_[pts_x, -10.445]
pts_y = r_[pts_y, 38.470]
pts_x = r_[pts_x, -10.445]
pts_y = r_[pts_y, 39.370]
pts_x = r_[pts_x, -9.545]
pts_y = r_[pts_y, 39.370]
pts_x = r_[pts_x, -9.545]
pts_y = r_[pts_y, 38.470]
...
pts_x = np.array([])
pts_y = np.array([])
pts_x = r_[pts_x, 9.555]
pts_y = r_[pts_y, 42.630]
pts_x = r_[pts_x, 9.555]
pts_y = r_[pts_y, 43.530]
pts_x = r_[pts_x, 10.455]
pts_y = r_[pts_y, 43.530]
pts_x = r_[pts_x, 10.455]
pts_y = r_[pts_y, 42.630]
pts = np.array([pts_x, pts_y])
...
pts_x = np.array([])
pts_y = np.array([])
pts_x = r_[pts_x, 11.515]
pts_y = r_[pts_y, 42.630]
pts_x = r_[pts_x, 11.515]
pts_y = r_[pts_y, 43.530]
pts_x = r_[pts_x, 12.415]
pts_y = r_[pts_y, 43.530]
pts_x = r_[pts_x, 12.415]
pts_y = r_[pts_y, 42.630]
pts = np.array([pts_x, pts_y])
...
pts_x = np.array([])
pts_y = np.array([])
pts_x = r_[pts_x, 13.475]
pts_y = r_[pts_y, 42.630]
pts_x = r_[pts_x, 13.475]
pts_y = r_[pts_y, 43.530]
pts_x = r_[pts_x, 14.375]
pts_y = r_[pts_y, 43.530]
pts_x = r_[pts_x, 14.375]
pts_y = r_[pts_y, 42.630]
pts = np.array([pts_x, pts_y])
...
pts_y = np.array([])
pts_x = r_[pts_x, 9.555]
pts_y = r_[pts_y, 44.590]
pts_x = r_[pts_x, 9.555]
pts_y = r_[pts_y, 45.490]
pts_x = r_[pts_x, 10.455]
pts_y = r_[pts_y, 45.490]
pts_x = r_[pts_x, 10.455]
pts_y = r_[pts_y, 44.590]
...
pts_y = np.array([])
pts_x = r_[pts_x, 9.555]
pts_y = r_[pts_y, 46.550]
pts_x = r_[pts_x, 9.555]
pts_y = r_[pts_y, 47.450]
pts_x = r_[pts_x, 10.455]
pts_y = r_[pts_y, 47.450]
pts_x = r_[pts_x, 10.455]
pts_y = r_[pts_y, 46.550]
...
pts_y = np.array([])
pts_x = r_[pts_x, 9.555]
pts_y = r_[pts_y, 48.510]
pts_x = r_[pts_x, 9.555]
pts_y = r_[pts_y, 49.410]
pts_x = r_[pts_x, 10.455]
pts_y = r_[pts_y, 49.410]
pts_x = r_[pts_x, 10.455]
pts_y = r_[pts_y, 48.510]
...
pts_y = np.array([])
pts_x = r_[pts_x, 9.555]
pts_y = r_[pts_y, 50.470]
pts_x = r_[pts_x, 9.555]
pts_y = r_[pts_y, 51.370]
pts_x = r_[pts_x, 10.455]
pts_y = r_[pts_y, 51.370]
pts_x = r_[pts_x, 10.455]
pts_y = r_[pts_y, 50.470]
...
geometry_xmin= -115.520
geometry_xmax= 115.520
geometry_ymin= -1.000
geometry_ymax= 261.040
...
port1 = FDTD.AddLumpedPort(1, 50, [-30, 0, TopMetal1_zmin], [-22, 10, TopMetal1_zmax], 'x', 1.0, priority=150)
port2 = FDTD.AddLumpedPort(2, 50, [22, 0, TopMetal1_zmin], [30, 10, TopMetal1_zmax], 'x', 1.0, priority=150)
...
if not preview_only:  # start simulation 
    ...
    # Calcul des signaux aux ports
    port1.CalcPort(sim_path, f)
    port2.CalcPort(sim_path, f)

    # Extraction des signaux incident et réfléchi
    a1 = port1.uf_inc
    b1 = port1.uf_ref
    a2 = port2.uf_inc
    b2 = port2.uf_ref

    # Calcul des S-parameters
    S11 = b1 / a1
    S21 = b2 / a1
    S12 = b1 / a2
    S22 = b2 / a2
    ...
    # (Optionnel) Phases en degrés
    S11_phase = np.angle(S11, deg=True)
    S21_phase = np.angle(S21, deg=True)
    S12_phase = np.angle(S12, deg=True)
    S22_phase = np.angle(S22, deg=True)

    Zin1 = port1.uf_tot / port1.if_tot
    Zin2 = port2.uf_tot / port2.if_tot
...
# Chemin du fichier .s2p
s2p_name = os.path.join(sim_path, model_basename + '.s2p')

# Création du fichier
with open(s2p_name, 'w') as s2p_file:
    # En-tête Touchstone standard
    s2p_file.write('# Hz S RI R 50\n')
    s2p_file.write('!\n')  # Ligne de commentaire facultative

    for i in range(numfreq):
        freq = f[i]
        # Extraire chaque composante complexe
        s11_re, s11_im = real(S11[i]), imag(S11[i])
        s21_re, s21_im = real(S21[i]), imag(S21[i])
        s12_re, s12_im = real(S12[i]), imag(S12[i])
        s22_re, s22_im = real(S22[i]), imag(S22[i])

        # Écriture sur une ligne : freq S11 S21 S12 S22 (ordre Touchstone)
        s2p_file.write(f"{freq}  {s11_re} {s11_im}  {s21_re} {s21_im}  "
                       f"{s12_re} {s12_im}  {s22_re} {s22_im}\n")
