...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=Resistance_Rsil.dat>
  <DataDisplay=Resistance_Rsil.dpl>
  <OpenDisplay=0>
  <Script=Resistance_Rsil.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Titre>
  <FrameText1=Auteur :>
...
<Components>
  ...
  <Lib rsil1 1 460 410 50 -26 0 0 "/home/userproj/QucsWorkspace/user_lib/IHP_PDK_basic_components" 0 "rsil" 0 "w" 1 "l" 1 "1" 0>
  ...
  <SpicePar SpicePar1 1 120 530 -28 18 0 0 "w=44.56u" 1 "l=294.599u" 1>
