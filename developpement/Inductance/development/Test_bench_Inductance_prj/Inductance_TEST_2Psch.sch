...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=Inductance_TEST_2Psch.dat>
  <DataDisplay=Inductance_TEST_2Psch.dpl>
  <OpenDisplay=0>
  <Script=Inductance_TEST_2Psch.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Titre>
  <FrameText1=Auteur :>
...
<Components>
  ...
  <SPfile X1 1 460 390 -26 -55 0 0 "/home/userproj/QucsWorkspace/ZigBee_Proj/Inductance/lib_ind_param_s/Ind_1P_3nH_High_Q_simu.s1p" 1 "rectangular" 0 "linear" 0 "open" 0 "2" 0>
  <Pac P2 1 580 420 18 -26 0 1 "2" 1 "50 Ohm" 1 "0 dBm" 0 "1 MHz" 0 "26.85" 0 "true" 0>
