...
<Properties>
  <View=333,413,1065,807,2.14758,0,0>
  <Grid=10,10,1>
  <DataSet=Modele_Inductance_1.6nH.dat>
  <DataDisplay=Modele_Inductance_1.6nH.dpl>
  <OpenDisplay=0>
  <Script=Modele_Inductance_1.6nH.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Titre>
  <FrameText1=Auteur :>
...
<Components>
  <L Ls 1 740 550 -26 10 0 0 "1.65n" 1 "" 0>
  <Port GND 1 670 730 12 7 0 1 "3" 1 "inout" 0>
  <Port OUT 1 890 550 4 -46 0 2 "2" 1 "out" 0>
  <Port IN 1 490 550 -23 12 0 0 "1" 1 "in" 0>
  <R Rs 1 650 550 -26 15 0 0 "2.27" 1 "26.85" 0 "0.0" 0 "0.0" 0 "26.85" 0 "european" 0>
  <C Csp 1 680 510 -26 -51 0 2 "25.785f" 1 "" 0 "neutral" 0>
  <R Rp1 1 540 660 15 -26 0 1 "72.575" 1 "26.85" 0 "0.0" 0 "0.0" 0 "26.85" 0 "european" 0>
  <R Rp2 1 790 660 15 -26 0 1 "72.575" 1 "26.85" 0 "0.0" 0 "0.0" 0 "26.85" 0 "european" 0>
  <C Cox1 1 540 590 17 -26 0 1 "10f" 1 "" 0 "neutral" 0>
  <C Cox2 1 790 600 17 -26 0 1 "10f" 1 "" 0 "neutral" 0>
</Components>
<Wires>
