...
<Properties>
  <View=-522,-83,2220,1279,0.840041,334,0>
  <Grid=5,5,1>
...
<Components>
  ...
  <.CUSTOMSIM CUSTOM2 0 80 20 0 41 0 0 "tran 50p 100n 0\nlinearize v(vin)\nfft v(vin)\nlet s_vin=mag(v(vin))\nplot s_vin\n" 1 "s_vin;" 0 "custom#ac1#.plot;custom#ac1#.print" 0>
  <.TR TR1 1 1180 15 0 99 0 0 "lin" 1 "0" 1 "280 ns" 1 "13500" 0 "Trapezoidal" 0 "2" 0 "1 ns" 0 "1e-16" 0 "150" 0 "0.001" 0 "1 pA" 0 "1 uV" 0 "26.85" 0 "1e-3" 0 "1e-6" 0 "1" 0 "CroutLU" 0 "no" 0 "yes" 0 "0" 0>
  <.CUSTOMSIM CUSTOM1 0 870 15 0 41 0 0 "tran 50p 100n 0\nlet diff_MIXER = v(VOUTP_MIXER)- v(VOUTN_MIXER)\nlinearize diff_MIXER	\nfft diff_MIXER	\nlet s_mixer=mag(diff_MIXER)\nplot s_mixer\n" 1 "s_mixer;" 0 "custom#ac1#.plot;custom#ac1#.print" 0>
  <.CUSTOMSIM CUSTOM3 0 360 20 0 41 0 0 "tran 50p 100n 0\nlet diff_LNA = v(VOUTP_LNA) - v(VOUTN_LNA)\nlinearize diff_LNA\nfft diff_LNA\nlet s_lna=mag(diff_LNA)\nplot s_lna\n" 1 "s_lna;" 0 "custom#ac1#.plot;custom#ac1#.print" 0>
  <.CUSTOMSIM CUSTOM4 0 635 15 0 41 0 0 "tran 50p 100n 0\nlinearize v(VOLPOS)\nfft v(VOLPOS)\nlet s_VOLPOS=mag(v(VOLPOS))\nplot s_VOLPOS\n" 1 "s_VOLPOS;" 0 "custom#ac1#.plot;custom#ac1#.print" 0>
  <Sub SUB3 1 1225 630 43 -26 0 1 "/home/userproj/QucsWorkspace/Zigbee/PLL/PLL_verilog_A/symbole/VCOsarah.sch" 0>
</Components>
<Wires>
  ...
  <1220 670 1220 670 "VCTRL" 1255 690 0 "">
</Wires>
<Diagrams>
  ...
  <Rect 1325 1195 240 160 3 #c0c0c0 1 00 1 0 2e+09 1.0005e+10 1 -0.00116599 0.005 0.0128639 1 -1 1 1 315 0 225 1 0 0 "" "" "">
	<"ngspice/custom1.ac.s_mixer" #00ff00 0 3 0 0 0>
	  <Mkr 9.77051e+06/0/0 -185 -207 3 0 0>
	  <Mkr 4.90479e+09/0/0 178 -207 3 0 0>
  </Rect>
  ...
  <Rect 1310 920 240 160 3 #c0c0c0 1 00 1 0 5e-08 2.8e-07 1 -0.0238321 0.02 0.0238425 1 -1 1 1 315 0 225 1 0 0 "" "" "">
	<"ngspice/tran.vout_flt" #00ff7f 0 3 0 0 0>
	  <Mkr 1.00007e-07/0/0/0/0 -130 -134 3 0 0>
	<"ngspice/tran.vout" #ff0000 1 3 0 0 0>
	  <Mkr 1.7687e-07 212 -206 3 0 0>
  </Rect>
